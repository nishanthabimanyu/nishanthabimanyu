...
# Nishanth M
### DevOps Engineer | Backend Developer | Infrastructure Automator
...
**Note on Activity:**
While my public GitHub profile showcases my academic and personal projects, a significant portion of my technical contribution happens in **private repositories** for **research and experimental use** involving **expired patents** under **Section 47(3) of the Indian Patents Act, 1970**.
...
*   **Cloud Infrastructure:** Managing containerized deployments using **Docker** and **Azure**.
*   **Optimization:** Refactoring legacy codebases for improved latency and scalability.
...
| **Automation & Tools** | ![n8n](https://img.shields.io/badge/n8n-FF6584?style=flat-square&logo=n8n&logoColor=white) ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) ![Cisco](https://img.shields.io/badge/Cisco-049FD9?style=flat-square&logo=cisco&logoColor=white) |
...
| :--- | :--- | :--- |
| **[freeCodeCamp-Microservices](https://github.com/nishanthabimanyu/freeCodeCamp-Microservices)** | A monorepo containing 5 distinct microservices (File Transfer, URL Shortener, etc.) built with Node.js/Express. | **Microservices** |
| **[VisuSTEM](https://github.com/nishanthabimanyu/VisuSTEM)** | An interactive EdTech platform utilizing **Allan Paivio's Dual Coding Theory** to enhance STEM learning via AI and visualization. | **Full Stack** |
| **[Surya-Siddhanta](https://github.com/nishanthabimanyu/Surya-Siddhanta)** | Computational archaeology project recovering ancient Indian mathematics through OCR and data analysis. | **Research** |
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=nishanthabimanyu&show_icons=true&theme=gotham&hide_border=true&count_private=true" alt="Nishanth's Stats" />
</div>
